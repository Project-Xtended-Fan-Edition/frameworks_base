...
public class BatteryMeterView extends LinearLayout implements DarkReceiver ,TunerService.Tunable {
    ...
    public void onBatteryLevelChanged(@IntRange(from = 0, to = 100) int level, boolean pluggedIn) {
        ...
        mLandscapeBatteryE.setCharging(isCharging());
        mLandscapeBatteryF.setCharging(isCharging());
        mLandscapeBatteryG.setCharging(isCharging());
        mLandscapeBatteryH.setCharging(isCharging());
        mLandscapeBatteryI.setCharging(isCharging());
        mLandscapeBatteryJ.setCharging(isCharging());
        mLandscapeBatteryK.setCharging(isCharging());
